...
const slides = [
  {
    ...
    caption:
      "Our Lagos, Nigeria headquarters - where every global payment journey begins.",
    tag: "Our People",
  },
  {
    ...
    caption:
      "Real-time transaction tracking across 50+ countries from a single dashboard.",
    tag: "Our Platform",
  },
  {
    ...
    caption:
      "Empowering entrepreneurs across Africa with fast, reliable financial tools.",
    tag: "Our Impact",
  },
  {
    ...
    caption:
      "The Saucam Exchange App — multi-currency wallets in your pocket, 24 × 7.",
    tag: "Our Product",
  },
];
const Business = () => {
    ...
    <main className="bg-slate-950 text-white">
      ...
      <div className="min-h-screen bg-slate-950 grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 px-3 sm:px-6 lg:px-10 py-16 md:py-24 items-center">
        ...
        <div className="flex flex-col gap-4">
          {/* ── Main image frame ── */}
          <div
            className="relative rounded-2xl overflow-hidden bg-slate-800 border border-slate-700/60"
            ...
            <div className="absolute inset-y-0 left-0 right-0 flex items-center justify-between px-3 pointer-events-none">
              {(["prev", "next"] as const).map((dir) => (
                ...
                >
                  ...
                  >
                    <path
                      d={dir === "next" ? "M5 4l4 4-4 4" : "M11 4L7 8l4 4"}
                    />
                  </svg>
                </button>
              ))}
              ...
              {slides.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    height: 6,
                    background:
                      i === slideIndex ? "#3B82F6" : "rgba(255,255,255,0.2)",
                  }}
            ...
            <div className="relative z-10 max-w-5xl mx-auto w-full px-3 sm:px-6 md:px-8">
                          ...
                          background:
                            i < activeStep
                              ...
                              : i === activeStep
                                ? "#1D4ED8"
                                : "#FFFFFF",
                          borderColor: i <= activeStep ? "#3B82F6" : "#CBD5E1",
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-6">
                ...
                <div
                  ...
                  style={{
                    animation:
                      "stepCardIn 0.45s cubic-bezier(0.22,1,0.36,1) both",
                  }}
                >
                  {/* Step icon + number */}
                  ...
                  {steps.map((step, i) => (
                    <div
                      ...
                      style={{
                        ...
                        opacity:
                          i < activeStep ? 0.4 : i === activeStep ? 1 : 0.55,
                      }}
                    >
                      <div
